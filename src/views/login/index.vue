<script setup lang="ts">
  ...
  const { locale, translationCh, translationTw, translationEn, translationJa, translationKo } = useTranslationLang();
          ...
          <el-form v-if="currentPage === 0" ref="ruleFormRef" :model="ruleForm" :rules="loginRules" size="large">
            <Motion :delay="100">
              <el-form-item
                ...
                prop="username"
              >
                <el-input v-model="ruleForm.username" clearable placeholder="账号或者手机号" :prefix-icon="useRenderIcon(User)" />
              </el-form-item>
            </Motion>
            ...
            <Motion :delay="200">
              <el-form-item prop="verifyCode">
                <el-input v-model="ruleForm.verifyCode" clearable :placeholder="t('login.pureVerifyCode')" :prefix-icon="useRenderIcon(Keyhole)">
