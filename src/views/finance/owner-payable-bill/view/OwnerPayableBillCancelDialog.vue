<template>
  <el-form ref="formRef" :model="form" :rules="rules" label-position="top">
    ...
    <el-form-item label="作废原因" prop="cancelReason" class="mt-4">
      <el-input v-model="form.cancelReason" type="textarea" :rows="4" maxlength="200" show-word-limit />
    </el-form-item>
  </el-form>
</template>
...
<script setup lang="ts">
  ...
  defineOptions({ name: "OwnerPayableBillCancelDialog" });
