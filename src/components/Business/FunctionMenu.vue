...
<style lang="scss" scoped>
  ...
  // 滚动条样式
  .function-dropdown-menu::-webkit-scrollbar {
    width: 4px;
  }

  .function-dropdown-menu::-webkit-scrollbar-thumb {
    background-color: #dcdfe6;
    border-radius: 2px;
  }

  .function-dropdown-menu::-webkit-scrollbar-thumb:hover {
